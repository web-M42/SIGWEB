...
const dashSalesData = [
  { title: 'Acessos mensais', amount: '15.000', icon: 'icon-arrow-up text-c-green', value: 50, class: 'progress-c-theme' },
  { title: 'Novos usuários', amount: '250', icon: 'icon-arrow-down text-c-red', value: 36, class: 'progress-c-theme2' },
  { title: 'Downloads no mês', amount: '1.500', icon: 'icon-arrow-up text-c-green', value: 70, color: 'progress-c-theme' }
];
      ...
      <Row>
        ...
        <Col md={6} xl={8}>
          <Card className="Recent-Users widget-focus-lg">
            <Card.Header>
              <Card.Title as="h5">Últimos usuários cadastrados</Card.Title>
            </Card.Header>
          ...
          <Card className="card-event">
            <Card.Body>
              <div className="row align-items-center justify-content-center">
                <div className="col">
                  <h5 className="m-0">Dados mais baixados</h5>
                </div>
              ...
              <h2 className="mt-2 f-w-300">
                45<sub className="text-muted f-14">downloads</sub>
              </h2>
              <h3 className="text-muted mt-3 mb-0">Bacia do araguaia</h3>
